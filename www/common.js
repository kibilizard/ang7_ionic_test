...
/***/ "./src/app/datalist/recepies.service.ts":
/*!**********************************************!*\
  !*** ./src/app/datalist/recepies.service.ts ***!
  \**********************************************/
...
var RecepiesService = /** @class */ (function () {
    function RecepiesService() {
        this.recipes = [
            {
                id: 'r1',
                title: 'Schnitzel',
    ...
    RecepiesService.prototype.getAllRecipes = function () {
        return this.recipes.slice();
    };
    RecepiesService.prototype.getRecipe = function (recipeID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.recipes.find(function (recipe) { return recipe.id === recipeID; }));
    };
    RecepiesService.prototype.deleteRecipe = function (recipeId) {
        this.recipes = this.recipes.filter(function (recipe) { return recipe.id !== recipeId; });
    };
    RecepiesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], RecepiesService);
    return RecepiesService;
}());
